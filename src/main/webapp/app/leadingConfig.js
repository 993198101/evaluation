...
//通知消息全局配置
angular.module("MetronicApp").config(["uiCalendarConfig",function (uiCalendarConfig) {
    angular.extend(uiCalendarConfig,{
            header: {
                left: '',
                center: 'today prev title next createSchedule',
                right: ''
            },
...
angular.module("MetronicApp").factory('settings', ['$rootScope', function ($rootScope) {
    ...
    var settings = {
        ...
        pagesImgPath: Metronic.getAssetsPath() + 'pages/img'
    };
